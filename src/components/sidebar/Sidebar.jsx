...
const Sidebar = () => {
  return (
    <div className="fixed left-0 bottom-0 md:left-0 w-full md:w-auto bg-gray-500 bg-opacity-30 md:bg-opacity-70 p-4 md:p-2 flex md:flex-col justify-center items-center gap-4 rounded-full rounded-bl-full md:rounded-tr-full md:rounded-br-full z-50 md:top-1/2 md:transform md:-translate-y-1/2">
      <NavLink
        to="/#home-section"
